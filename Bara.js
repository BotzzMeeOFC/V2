...
const sewa = fs.readFileSync("./media/gambar/comand/sewa.jpg");
...
module.exports = Bara = async (Bara, mek) => {
		try {
            ...
            const prefix = /^[°ꕥ π÷×¶∆£¢€¥®™=|~!#$%^&.?/\\©^z+*@,;]/.test(cmd) ? cmd.match(/^[°ꕥ π÷×¶∆£¢€¥®™=|~!#$%^&.?/\\©^z+*,;]/gi) : ',' 
...
//━━━━━━━━━━━━━━━[ HARI HARI ]━━━━━━━━━━━━━━━\\
        ...
        const isUrl = (url) => {
			...
			const reply = (teks) => {
			Bara.sendMessage(from, teks, text, { thumbnail: gember, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} WIB - ${week}`,body:"${fake}",previewType:"PHOTO",thumbnail:gember,sourceUrl:`https://wa.me/p/6349482305092740/6285697662826`}}})
		}
		const reply2 = (teks) => {
...
//━━━━━━━━━━━━━━━[ BUAT BIO BOT ]━━━━━━━━━━━━━━━\\
runi = process.uptime() 
           Bara.setStatus(`Aktif Selama ${kyun(runi)} `).catch((_)=>_);
...
anu =`*Hai @${pushname}👋
╭────❑ *Info Bot* ❑────
│ ꕥ  *Name Bot* : _*${namabot}*_
│ ꕥ  *Baterai* : *_*Tidak Terdeteksi*_
│ ꕥ  *Version* : _*2.0.0*_
│ ꕥ  *Library* : _*Lib_Baileys*_
│ ꕥ  *Nama Owner* : _*${namaowner}*_
│ ꕥ  *Taggal* : _*${Tanggal}*_
╰❑ `
...
┃⬡ Jadi Bot : 5k
┃⬡ Jadi Owner : 10k
┃⬡ Ganja? Bisa Tawar Dek 🗿
┗━━⬣
┏━━⬣ NOMOR ADMIN
┃⬡ wa.me/6283174508962
┃⬡ wa.me/6283842942635
┃⬡ Selain Nomor Di atas Clone!
┗━━⬣

NOTE : SEBELUM SEWA HENDAK NYA ANDA SUDAH TAU APA ITU BOT WHATSAPP

SISTEM : TF - BOT JOIN - DONE
...
➡︎ https://wa.me/message/FXLN3NJ45WZMM1

Instagram Admin :

➡︎ https://instagram.com/putraxdofc

YouTube Admin :

➡︎ https://bit.ly/3pYlrnN


Group Murid Bot :

➡︎ https://bit.ly/3CChNFv

Group Ofc :

➡︎ https://bit.ly/Groupofc

Group Team :

➡︎ https://bit.ly/GroupTeam
...
//══════════[ANIME MENU]════════════════════════════//
            ...
            if (isBanned) return reply(mess.banned)
              ...
              contentText:`Creator ${fake}`,buttons,headerType:4}
...
case 'tagall':
 ...
 if (isBanned) return reply(mess.banned)
                ...
                Bara.sendMessage(from, { text: tekss, mentions: participants.map(a => a.id) }, { quoted: fkontak })
            break
                                case 'promote':
                                if (isBanned) return reply(mess.banned)
if (!isGroup) return reply(mess.only.group)
